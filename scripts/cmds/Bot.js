...
module.exports.onChat = async ({ api, event }) => {
  ...
  const cMessages = ["🎀 Hello bby!", "🎀 Hi there!", "🎀 Hey! How can I help?"," amke na dak diye amr boss ke dako🐸🙂 " ," heyy bbz ❤️‍🩹🐤", " জান একটু আদর দাও না 🥺" , "🥰 আমি তোমাকে অনেক ভালোবাসি বাবু 🥺💖" , "কিরে বলদ তুই এখানে 😼" , "😒 তোর কি চোখে পড়ে না আমি ব্যস্ত আছি 😒" , " Bot বললে কিস করে দেবো কিন্তু 😘" , "👀 হেহে বাবু, আমার কাছে আসো 😘💋" , "🤔 বলদা তোর কথা তোর বাড়ি কেউ শুনে না, তো আমি কেন শুনবো?" , "😘 I love you! আমার সোনা, ময়না, টিয়া 😍" ,"তুই কাল দেখা করিস একটু 😈" , "🍹 এই নাও জুস খাও, বট বলতে বলতে হাপায় গেছো না 🥲" , " চলো চলে যাই বিদেশ্যে🤥" , " 🌸 দেখা হলে কাঠগোলাপ দিও 🤗 " , " 🫡 তোরে মারার প্রিপারেশন নিছি 😌" , " 🪄 তাবিজ কইরা হইলেও ফ্রেম এক্কান করমুই, তাতে যা হই হোক 🤧🥱" , "What adventures await us today? 🌈" , " amke nh dak diye amr boss rishi ke dako😺🤍🌚 ];
